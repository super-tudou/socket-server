 ...
 * @date   2021/4/9 1:56 下午
 * @desc   RedisService.php
 */

namespace service;

use config\ConfigConstance;
...
class RedisService extends BaseService
{
    ...
    protected function __init($params)
    {
        ...
        $this->port = $params['port'] ? $params['port'] : 6379;
    ...
    {
        empty($config) && $config = self::getConfig();
    ...
    {
        return [
            'host' => ConfigConstance::REDIS_ADDRESS,
            'port' => ConfigConstance::REDIS_PORT,
            'auth' => ConfigConstance::REDIS_AUTH,
            'db_id' => ConfigConstance::REDIS_DB,
        ];
    }
